...
export default function Hero() {
  ...
  const stats = [
    ...
    { number: '85+', label: 'Video Lessons' },
    { number: '4.9', label: 'Average Rating' },
  ];

  return (
    <section id="hero" className="relative min-h-screen overflow-hidden" style={{ backgroundColor: '#0A1628' }}>
      <canvas
        ref={canvasRef}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
        <div className="max-w-[720px] mx-auto text-center" style={{ paddingTop: '18vh' }}>
          {/* Tagline */}
          <div
          ...
          >
            Learn Real Backend Development with{' '}
            <span style={{ color: '#D4A853' }}>APIs</span>
          </h1>
          ...
          >
            Hands-on courses in REST APIs, Swagger, PostgreSQL, NestJS and JWT Authentication.
          </p>
          ...
          >
            {stats.map((stat, i) => (
              <div key={i} className="text-center">
                <div className="font-serif text-4xl font-medium" style={{ color: '#F0EDE5', letterSpacing: '-1px' }}>
                  {stat.number}
                </div>
                <div className="text-sm mt-1" style={{ color: '#8A9AB0' }}>
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center">
          <div className="relative w-[1px] h-8" style={{ backgroundColor: '#4A5A70' }}>
            <div
